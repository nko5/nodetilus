...
~~~sh
# getting the code
git clone git@github.com:nko5/nodetilus.git && cd ./nodetilus/
...
# deploying to Modulus (to http://nodetilus.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nodetilus" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
